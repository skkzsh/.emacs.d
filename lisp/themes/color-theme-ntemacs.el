...
(defun color-theme-ntemacs ()
  "original arjen Color theme by awiersma, created 2001-08-27."
  (interactive)
  (color-theme-install
   '(color-theme-ntemacs
     ...
     (variable-pitch ((t (:family (encode-coding-string "セプテンバーＭ-等幅教漢" 'sjis)))))
     (border-glyph ((t (nil))))
     ...
     (font-latex-title-4-face ((((class color) (background dark)) (:inherit variable-pitch :foreground "yellow" :weight bold))))
     (howm-mode-title-face ((((class color)) (:foreground "SkyBlue"))))
     (howm-reminder-normal-face ((((class color)) (:foreground "SkyBlue2"))))
     (howm-reminder-separator-face ((((class color) (background dark)) (:foreground "DarkGray"))))
